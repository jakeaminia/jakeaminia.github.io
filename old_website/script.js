...
function calculateGame() {
    ...
    for (let i = 0; i < playerCards.length; i++) {
        ...
        let result = "Player " + (i + 1) + "'s best number is " + currBestScore + " (" + printCards(currBestCards) + "), which is " + offBy(currBestScore, product) + " away from a multiple of " + product
